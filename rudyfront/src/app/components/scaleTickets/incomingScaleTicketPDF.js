angular.module('myApp.incomingScaleTicketPDF', [])
    .controller('incomingScaleTicketPDFCtrl', function($scope, scaleTicketHttpServices, imageUrl, $rootScope, httpService, $state, $stateParams, $timeout, spinnerService) {


        $scope.$on('access', (event, data) => {
            if (!data.truckScale.incoming.view) {
